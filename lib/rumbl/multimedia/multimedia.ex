defmodule Rumbl.Multimedia do
  ...
  def list_user_videos(%Account.User{} = user) do
    Video
  ...
  def get_user_video!(%Account.User{} = user, id) do
  ...
  """
  def get_video!(id), do: Repo.get!(Video, id) |> preload_user()
  ...
  """
  def change_video(%Account.User{} = user, %Video{} = video) do
    video
    |> Video.changeset(%{})
    |> put_user(user)
  end
